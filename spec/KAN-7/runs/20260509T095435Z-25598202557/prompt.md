...
- This is a continuation. If your in-memory session is missing, rebuild context from `spec/KAN-7/transcript.md`, `spec/KAN-7/plan.md`, and the `runs/` folder under the ticket.
